...
import com.allanbil214.leafyapp.databinding.ActivityMainBinding
import com.allanbil214.leafyapp.databinding.WeatherPreviewCardBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var weatherCardBinding: WeatherPreviewCardBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Initialize the included layout's binding
        weatherCardBinding = WeatherPreviewCardBinding.bind(binding.weatherPreviewCard.root)

        // Now you can set the click listener on the included layout's root view
        binding.weatherPreviewCard.root.setOnClickListener {
